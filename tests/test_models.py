...
class ModelsTest(unittest.TestCase):
    ...
    **CoralLayer.forward (ejemplo con input features 4 (input_size) y out features 2 (logits k-1))**\n
    ...
    def test_grad(self):
        ...
        input = torch.tensor([[1.,2.,4.,8.],[1.,1.,2.,2.],[1.,1.,1.,1.]], dtype=torch.float64, requires_grad=True)

        self.assertTrue(torch.autograd.gradcheck(fc1, input, eps=1e-6, atol=1e-4))
